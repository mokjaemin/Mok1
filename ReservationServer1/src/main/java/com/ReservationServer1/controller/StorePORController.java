...
public class StorePORController {
  ...
  @Operation(summary = "가게 예약 등록 요청", description = "가게 예약 정보가 등록됩니다.",
      tags = {"Store Reservation Order Payment Coupon Controller"})
  @ApiResponses({
  ...
  @Operation(summary = "가게 결제정보 고객댓글 작성 요청", description = "가게 결제정보 고객댓글 작성됩니다.",
      tags = {"Store Reservation Order Payment Coupon Controller"})
  @ApiResponses({
      @ApiResponse(responseCode = "200", description = "OK",
          content = @Content(schema = @Schema(implementation = PayDTO.class))),
  ...
  public ResponseEntity<String> registerComment(@Valid @RequestParam long reservationId,
    ...
    return ResponseEntity.status(HttpStatus.OK).body(
        storePORService.registerComment(reservationId, new_comment, authentication.getName()));
  }


  @DeleteMapping("/pay/comment")
  @Operation(summary = "가게 결제정보 고객댓글 삭제 요청", description = "가게 결제정보 고객댓글이 삭제됩니다.",
      tags = {"Store Reservation Order Payment Coupon Controller"})
  @ApiResponses({@ApiResponse(responseCode = "200", description = "OK"),
      @ApiResponse(responseCode = "400", description = "BAD REQUEST"),
      @ApiResponse(responseCode = "404", description = "NOT FOUND"),
  ...
  @Operation(summary = "가게 결제정보 대댓글 작성 요청", description = "가게 결제정보 대댓글 작성됩니다.",
      tags = {"Store Reservation Order Payment Coupon Controller"})
  @ApiResponses({
      @ApiResponse(responseCode = "200", description = "OK",
          content = @Content(schema = @Schema(implementation = PayDTO.class))),
  ...
  @Operation(summary = "가게 결제정보 대댓글 삭제 요청", description = "가게 결제정보 대댓글이 삭제됩니다.",
      tags = {"Store Reservation Order Payment Coupon Controller"})
  @ApiResponses({@ApiResponse(responseCode = "200", description = "OK"),
      @ApiResponse(responseCode = "400", description = "BAD REQUEST"),
      @ApiResponse(responseCode = "404", description = "NOT FOUND"),
  ...
  @Operation(summary = "가게 회원별 쿠폰정보 출력 요청", description = "가게 회원별 쿠폰 정보가 출력됩니다.",
      tags = {"Store Reservation Order Payment Coupon Controller"})
  @ApiResponses({@ApiResponse(responseCode = "200", description = "OK"),
      @ApiResponse(responseCode = "400", description = "BAD REQUEST"),
      @ApiResponse(responseCode = "404", description = "NOT FOUND"),
  ...
  @Operation(summary = "가게별 전체 회원 쿠폰정보 출력 요청", description = "가게별 전체 회원 쿠폰정보가 출력됩니다.",
      tags = {"Store Reservation Order Payment Coupon Controller"})
  @ApiResponses({@ApiResponse(responseCode = "200", description = "OK"),
      @ApiResponse(responseCode = "400", description = "BAD REQUEST"),
      @ApiResponse(responseCode = "404", description = "NOT FOUND"),
