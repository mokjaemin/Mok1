...
public class MemberEntity extends BaseEntity {
  ...
  public MemberDTO toDomain() {
    return MemberDTO.builder().userId(this.userId).userPwd(this.userPwd).userName(this.userName)
        .userNumber(this.userNumber).userAddress(this.userAddress).userEmail(this.userEmail).build();
  }
}
