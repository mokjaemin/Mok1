...
public class StoreEntity extends BaseEntity {
  ...
  private static final StoreEntity sample =
      StoreEntity.builder().storeId((short)-1).storeName("storeName").ownerId("ownerId").country("country")
          .city("city").dong("dong").type(StoreType.KOREAN).couponInfo("couponInfo").build();
