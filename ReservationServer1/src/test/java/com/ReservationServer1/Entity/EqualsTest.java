...
public class EqualsTest {
  ...
  void ReservationSystem() throws Exception {
    ...
    StoreReservationEntity reservation = StoreReservationEntity.builder().storeId(0)
        .userId("userId").storeId(0).date("date").time("time").storeTable("storeTable").build();
    ...
    StoreReservationEntity reservation2 = StoreReservationEntity.builder().storeId(0)
        .userId("userId").storeId(0).date("date").time("time").storeTable("storeTable").build();
