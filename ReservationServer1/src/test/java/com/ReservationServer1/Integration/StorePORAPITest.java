...
//
//    // then
//    resultActions.andExpect(status().isOk()).andExpect(MockMvcResultMatchers.content()
...
//
//  @Test
//  @DisplayName("StorePORAPI : Register Pay Success")
//  @WithMockUser(username = "0", roles = "OWNER")
//  public Long registerPaySuccess() throws Exception {
//    // given
//    // 저장
...
//    // given
//    // 저장
//    Long reservationId = registerPaySuccess();
//    int storeId = 0;
//    String response = "success";
//
//    // when
...
//
//
//    PayDTO payDTO = PayDTO.sample();
//    StorePayEntity entity1 = StorePayEntity.builder().amount(payDTO.getAmount()).build();
//    entity1.setStoreOrdersEntity(entity.getChild());
//    em.persist(entity1);
//    entity.getChild().setPayment(entity1);
//
//
//    StoreCouponEntity newCoupon = StoreCouponEntity.builder().storeId(entity.getStoreId())
//        .userId(entity.getUserId()).amount(1).build();
