...
////        StoreType.KOREAN, anyInt(), anyInt());
////
////    // when
...
////        .param("city", "City").param("dong", "Dong").param("type", "KOREAN").param("page", "1")
////        .param("size", "10"));
////
////    // then
...
//        MockMvcRequestBuilders.get("/store").with(csrf()).contentType(MediaType.APPLICATION_JSON));
//
//    // then
//    resultActions.andExpect(status().isBadRequest());
//  }
